...
<div class="max-w-lg mx-auto bg-white rounded-xl shadow-lg p-8 mt-10">
    <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Thêm danh mục mới</h1>

    <form action="<?= BASE_URL ?>/admin/categories/create" id="categoryForm" method="post" class="space-y-6">
        ...
        <div>
            ...
            <input type="color" name="color" value="#f472b6"
